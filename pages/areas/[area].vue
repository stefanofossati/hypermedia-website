  ...
  <div>
    ...
    <div id="carousel" class="relative w-full">
      ...
      <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
        <!-- Items -->
        <div class="transition-opacity duration-1000 ease-in-out" id="1">
    ...
    <div>
      <div class="text-4xl text-center font-bold text-white mt-12">GREEN ENERGY</div>
      <p class="text-xl text-center text-white mt-4">ok praticamente questo è un testo che descrive l'impatto delle energie rinnovabili in un ambiente che ha troppa
                        anidride carbonica ed è un casino assurdo</p>
    </div>

    <!--Carousel to browse different project inside the area-->
    <div>
      <div class="text-4xl text-center font-bold text-white mt-20 mb-8">RELATED PROJECTS</div>
      <div class="relative w-1/2 left-1/2 -translate-x-1/2 mb-20">
        ...
        <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
          ...
          <button type="button" class="absolute top-0 left-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
            <span class="inline-flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-white/30 dark:bg-gray-800/90 group-hover:bg-white/50 dark:group-hover:bg-white/80 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
