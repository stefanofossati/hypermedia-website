      ...
      <div class="relative w-1/2 left-1/2 -translate-x-1/2 mb-20">
        ...
        <div class="relative h-52 overflow-hidden rounded-lg md:h-96">
          ...
          <button type="button"
            ...
            <span
                class="inline-flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-white/30 dark:bg-gray-700/80 group-hover:bg-white/50 dark:group-hover:bg-white/80 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
