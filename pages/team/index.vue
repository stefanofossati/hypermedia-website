        ...
        <div v-for="person in team">
          <NuxtLink :to="`/team/${person.name}_${person.surname}`"
            ...
            <lazy-nuxt-img :src="person.img" :alt="`${person.name} ${person.surname}'s profile pic`"
                           class="h-64 md:h-72 lg:h-96 w-full relative group-hover:border-8 border-gray-600 rounded-xl"
                           placeholder="~/assets/xp.jpg"/>
            <div class="absolute bottom-0 group-hover:bottom-2 rounded-b-xl backdrop-blur-3xl group-hover:border-x-8 border-gray-600 w-full p-1.5 ">
              <div class="font-bold">
