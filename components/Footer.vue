  ...
  <footer class="bg-white dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl p-2 py-6 lg:py-8">
      <div class="sm:flex sm:justify-between">
        ...
        <div class="flex flex-row justify-evenly gap-8 sm:grid sm:grid-cols-3 sm:mr-8 sm:mt-6">
          <div>
          ...
          <div>
            <h2 class="mb-6 text-sm font-bold text-gray-900 uppercase dark:text-white">Projects</h2>
            <ul class="text-gray-600 dark:text-gray-400 font-medium">
              <li class="mb-4">
                <NuxtLink to="/projects" class="hover:underline">Most Relevant</NuxtLink>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul class="text-gray-600 dark:text-gray-400 font-medium">
              <li class="mb-4">
                <NuxtLink to="/contact_us" class="hover:underline">Contact Us</NuxtLink>
              </li>
              <li>
                <NuxtLink to="/about_us" class="hover:underline">About Us</NuxtLink>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="flex flex-col items-center sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0 sm:mr-12">
          ...
          <NuxtLink to="https://youtu.be/dQw4w9WgXcQ"
                    class="text-gray-500 hover:text-gray-900 dark:hover:text-white cursor-pointer">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              <path fill-rule="evenodd"
          ...
          <NuxtLink to="https://github.com/stefanofossati/hypermedia-website.git"
                    class="text-gray-500 hover:text-gray-900 dark:hover:text-white cursor-pointer">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              <path fill-rule="evenodd"
          ...
          <NuxtLink to="https://discord.gg/9DBC7eQXp"
                    class="text-gray-500 hover:text-gray-900 dark:hover:text-white cursor-pointer">
            ...
            <span class="sr-only">Discord channel</span>
          </NuxtLink>
        </div>
      </div>
    </div>
