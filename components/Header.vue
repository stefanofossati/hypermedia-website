          ...
          <nav class="text-lg w-full font-bold text-slate-700 dark:text-slate-200">
            <ul class="flex justify-end">
              <li class="mr-8 lg:mr-16">
                <NuxtLink to="/areas" class="lg:text-2xl hover:text-orange-500 cursor-pointer" id="areas">All Areas
                </NuxtLink>
              </li>
              <li class="mr-8 lg:mr-16">
              ...
              <li class="mr-8 lg:mr-16">
                <NuxtLink to="/contact_us" class="lg:text-2xl hover:text-orange-500 cursor-pointer" id="contact">About
                  Us
                </NuxtLink>
              </li>
