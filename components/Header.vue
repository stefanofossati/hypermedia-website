        ...
        <div class="sm:w-60 flex flex:col justify-end items-center dark:bg-gray-900 bg-white pt-80">
          <nav class="text-right">
            <ul class="mr-3 my-2">
              ...
              <li class="text-white-500 font-bold py-1" title="Team section">
              ...
              <li class="text-white-500 font-bold py-1" title="About Us section">
              ...
              <li class="text-white-500 font-bold py-1" title="Contact Us section">
                <NuxtLink to="/contact_us" class="text-lg sm:text-2xl px-4 flex justify-end text-black dark:text-white
                                      hover:text-orange-500 border-r-4 border-orange-500 border-primary" id="contact"
                          v-on:click="manageMenu">
              ...
              <li class="inline-flex items-center" title="Light or Dark mode button">
                <div>
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 fill-slate-700 dark:fill-slate-200 mx-2" viewBox="0 -960 960 960">
                    <path
