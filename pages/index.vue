    ...
    <div class="bg-scroll bg-cover bg-center aspect-auto w-screen"
      ...
      <div
        ...
        <div class="homepage-right">
          <div class="homepage-line-right">
            <details class="homepage-details homepage-text-right">
        ...
        <div class="homepage-left">
          <div class="homepage-line-left">
            <lazy-nuxt-img src="https://ojnuafuxohzfjdijkfoi.supabase.co/storage/v1/object/public/Images/team.jpg"
                           alt="team picture"
        ...
        <div class="homepage-right mb-10">
          <div class="homepage-line-right">
            <details class="homepage-details homepage-text-right">
