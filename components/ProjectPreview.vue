...
<template>
  <div>
    <NuxtLink :to="'/projects/' + props.project_title">
      <div class="h-52 md:h-96 relative bg-center bg-cover rounded-lg hover:border-8 hover:border-slate-500" :style="'background-image: url(' + props.main_image + ')'"  :id="props.project_title">
